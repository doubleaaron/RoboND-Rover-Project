...
def perspect_transform(img, src, dst):
    ...
    # old method :: return warped without an outside mask
...
# Find some rocks , I messed around with values here, I wanted a cleaner threshold

def discover_rocks(img, levels=(110, 110, 50)):
...
def perception_step(Rover):
    ...
    scale = 2 * dst_size
    rock_x_world, rock_y_world = pix_to_world(xpix, ypix, Rover.pos[0], Rover.pos[1], Rover.yaw, world_size, scale)
    ...
    #improve fidelity of mapping here
